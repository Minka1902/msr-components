...
export interface HumanAccessManagerProps extends Omit<React.HTMLAttributes<HTMLDivElement>, "title"> {
  people: Caregiver[];
...
export const HumanAccessManager = React.forwardRef<HTMLDivElement, HumanAccessManagerProps>(
  function HumanAccessManager(
