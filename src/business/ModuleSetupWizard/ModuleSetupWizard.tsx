...
export interface ModuleSetupWizardProps extends Omit<React.HTMLAttributes<HTMLDivElement>, "onChange"> {
  steps: WizardStep[];
  active?: number;
...
export const ModuleSetupWizard = React.forwardRef<HTMLDivElement, ModuleSetupWizardProps>(
  function ModuleSetupWizard(
