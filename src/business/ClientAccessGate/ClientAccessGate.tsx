...
export interface ClientAccessGateProps extends React.HTMLAttributes<HTMLDivElement> {
...
export const ClientAccessGate = React.forwardRef<HTMLDivElement, ClientAccessGateProps>(
  function ClientAccessGate({ accessible, moduleName, blockers = [], action, className, ...rest }, ref) {
    return (
