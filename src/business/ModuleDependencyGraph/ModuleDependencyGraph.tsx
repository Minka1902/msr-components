...
export interface ModuleDependencyGraphProps extends React.HTMLAttributes<HTMLDivElement> {
  nodes: DependencyNode[];
  edges: DependencyEdge[];
}

/** Readable dependency view: each module and what it requires, flagging unmet deps. */
export const ModuleDependencyGraph = React.forwardRef<HTMLDivElement, ModuleDependencyGraphProps>(
  function ModuleDependencyGraph({ nodes, edges, className, ...rest }, ref) {
