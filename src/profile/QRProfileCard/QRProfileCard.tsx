...
export interface QRProfileCardProps extends React.HTMLAttributes<HTMLDivElement> {
 ...
 * scannable code.)
 */
export const QRProfileCard = React.forwardRef<HTMLDivElement, QRProfileCardProps>(
  function QRProfileCard(
    ...
    return (
      <div ref={ref} className={cx("msr-QRProfileCard", className)} {...rest}>
        <QRCode className="msr-QRProfileCard__qr" value={qrValue} size={104} title="Collar QR code" />
        <div className="msr-QRProfileCard__body">
