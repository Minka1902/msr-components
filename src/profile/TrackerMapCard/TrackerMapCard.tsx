...
export interface TrackerMapCardProps extends React.HTMLAttributes<HTMLDivElement> {
  latitude: number;
  longitude: number;
...
export const TrackerMapCard = React.forwardRef<HTMLDivElement, TrackerMapCardProps>(
  function TrackerMapCard(
