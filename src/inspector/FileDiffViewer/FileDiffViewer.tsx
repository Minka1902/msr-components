...
export interface FileDiffViewerProps extends React.HTMLAttributes<HTMLDivElement> {
  diff: FileDiff;
  beforeLabel?: string;
  afterLabel?: string;
...
export const FileDiffViewer = React.forwardRef<HTMLDivElement, FileDiffViewerProps>(
