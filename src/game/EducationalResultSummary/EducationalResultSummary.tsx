...
export interface EducationalResultSummaryProps extends Omit<React.HTMLAttributes<HTMLDivElement>, "title"> {
...
export const EducationalResultSummary = React.forwardRef<HTMLDivElement, EducationalResultSummaryProps>(
  function EducationalResultSummary({ title = "What you learned", learned, footer, className, ...rest }, ref) {
    return (
