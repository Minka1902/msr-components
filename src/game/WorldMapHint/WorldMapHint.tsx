...
export interface WorldMapHintProps extends React.HTMLAttributes<HTMLDivElement> {
...
export const WorldMapHint = React.forwardRef<HTMLDivElement, WorldMapHintProps>(
  function WorldMapHint({ bearing, distance, unit = "km", proximity, label, className, ...rest }, ref) {
