...
export interface MarketplaceProps extends React.HTMLAttributes<HTMLDivElement> {
...
export const Marketplace = React.forwardRef<HTMLDivElement, MarketplaceProps>(
  function Marketplace({ modules, onToggle, columns = 3, className, style, ...rest }, ref) {
    return (
      <div
        ref={ref}
