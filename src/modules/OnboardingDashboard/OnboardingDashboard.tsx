...
export interface OnboardingDashboardProps extends Omit<React.HTMLAttributes<HTMLDivElement>, "title"> {
...
export const OnboardingDashboard = React.forwardRef<HTMLDivElement, OnboardingDashboardProps>(
